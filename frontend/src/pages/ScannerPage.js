...
const styles = {
  ...
  pageSub: { color: '#8899aa', fontFamily: "'Inter',sans-serif", fontSize: '0.9rem' },
  ...
  inputWrapper: {
    ...
    background: '#111827', border: '1px solid #2a3f5f', borderRadius: '10px',
    padding: '0 1rem',
  },
  inputIcon: { fontSize: '0.9rem', flexShrink: 0 },
  input: {
    flex: 1, background: 'transparent', border: 'none', outline: 'none',
    color: '#e8edf5', fontFamily: "'Space Mono',monospace", fontSize: '0.85rem',
    padding: '0.85rem 0',
  },
  clearBtn: { background: 'none', border: 'none', color: '#4a5568', cursor: 'poInter', fontSize: '0.8rem', padding: '0.25rem' },
  analyzeBtn: {
    padding: '0 2rem', background: '#00d4ff', color: '#000',
    border: 'none', borderRadius: '10px', fontFamily: "'Space Grotesk',sans-serif",
  ...
  examplesLabel: { fontSize: '0.75rem', color: '#4a5568', fontFamily: "'Inter',sans-serif", marginRight: '0.25rem' },
  exampleChip: {
    padding: '0.3rem 0.75rem', borderRadius: '99px',
    border: '1px solid #1e2d45', background: 'transparent',
    color: '#8899aa', fontSize: '0.72rem', cursor: 'poInter',
    fontFamily: "'Space Mono',monospace",
  },

  errorBox: { background: 'rgba(255,61,90,0.08)', border: '1px solid rgba(255,61,90,0.25)', borderRadius: '10px', padding: '1rem 1.25rem', color: '#ff3d5a', fontSize: '0.875rem', fontFamily: "'Inter',sans-serif" },

  loadingCard: { background: '#111827', border: '1px solid #1e2d45', borderRadius: '12px', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem' },
  loadingSteps: { display: 'flex', gap: '1.5rem', flexWrap: 'wrap', justifyContent: 'center' },
  loadingStep: { display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.78rem', color: '#8899aa', fontFamily: "'Space Mono',monospace" },
  stepDot: { width: 6, height: 6, borderRadius: '50%', background: '#00d4ff', display: 'inline-block', animation: 'blink 1.4s ease-in-out infinite' },

  resultCard: { background: '#111827', border: '1px solid #1e2d45', borderRadius: '16px', padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.75rem', animation: 'fadeIn 0.4s ease' },
  ...
  resultUrlLabel: { fontSize: '0.7rem', color: '#4a5568', letterSpacing: '0.1em', fontFamily: "'Inter',sans-serif", fontWeight: 600, textTransform: 'uppercase' },
  resultUrl: { fontFamily: "'Space Mono',monospace", fontSize: '0.82rem', color: '#8899aa', wordBreak: 'break-all' },

  checksGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '0.75rem' },
  checkItem: { display: 'flex', alignItems: 'center', gap: '0.6rem', padding: '0.75rem 1rem', borderRadius: '8px', border: '1px solid', fontSize: '0.82rem', fontFamily: "'Inter',sans-serif", color: '#8899aa' },
  checkLabel: { flex: 1 },

  flagsSection: { display: 'flex', flexDirection: 'column', gap: '0.75rem' },
  flagsTitle: { fontFamily: "'Space Grotesk',sans-serif", fontWeight: 700, fontSize: '0.9rem', color: '#e8edf5' },
  flagsList: { display: 'flex', flexDirection: 'column', gap: '0.5rem' },
  flagItem: { borderLeft: '3px solid', padding: '0.6rem 1rem', background: 'rgba(0,0,0,0.2)', borderRadius: '0 6px 6px 0' },
  flagText: { fontSize: '0.83rem', color: '#8899aa', fontFamily: "'Inter',sans-serif" },

  resultMeta: { display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem', paddingTop: '1rem', borderTop: '1px solid #1e2d45', fontSize: '0.75rem', color: '#4a5568', fontFamily: "'Inter',sans-serif" },
  mono: { fontFamily: "'Space Mono',monospace", color: '#8899aa' },
};
